...
fig1 <- media%>%
  ...
  labs(x='Time Spent on Social Media', y='Propotion of Use by Marital Status', MStat = 'Marital Status', title='Fig 1: Time on Social Media by Marital Status')+
  theme_minimal()+
  scale_fill_manual(values = c("Divorced" = "#B0476E", "Married" = "#C9732A", 'Single' = '#3C7D3F', 'In a relationship' = '#4679B3')) +
  theme(text = element_text(hjust = 0.5, size=12, family='serif'), plot.title=element_text(hjust = 0.5), axis.text.x = element_text(angle = 30, hjust = 0.5, vjust = 0.5), panel.grid.major = element_blank())
...
fig2 <- media%>%
  ...
  labs(x='Time spent during the day on Social Media', y='Propotion of Use by Gender', title='Fig. 2: Time on Social Media by Gender')+
  theme_minimal()+
...
fig3 <- media %>% 
  ...
  geom_bar(stat = "identity", position='fill' , alpha=0.85)+
  labs(x='Social Media Platform', y='Propotion of Use by Gender', title='Fig. 3: Use of Social Media Platform by Gender')+
  theme_minimal()+
  scale_fill_manual(values = c("Female" = "#B0476E", "Male" = "#C9732A")) +
  theme(text = element_text(hjust = 0.5, size=12, family='serif'), plot.title=element_text(hjust = 0.5), axis.text.x = element_text(angle = 30, hjust = 0.5, vjust = 0.5), panel.grid.major = element_blank())
